...
class PageviewSpout extends KafkaSpout<String, String> {
    ...
    private static final String KAFKA_PAGEVIEW_GROUP_ID = "kafkaPageviewSpoutGroup";

    private static final String TOPIC_NAME = "pageviewIndex2_sifl1011";
    ...
    static {
        ...
        props.put(KafkaSpoutConfig.Consumer.GROUP_ID, KAFKA_PAGEVIEW_GROUP_ID);
