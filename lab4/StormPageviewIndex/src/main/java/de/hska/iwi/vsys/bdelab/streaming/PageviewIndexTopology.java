...
public class PageviewIndexTopology {
	...
	private static StormTopology buildTopology(){
        ...
        builder.setBolt("extractData_bolt", new ExtractDataBolt(), 2).shuffleGrouping("pageview_spout", PageviewSpout.STREAM_NAME);

        builder.setBolt("count_bolt", new PageviewCountBolt(), 2).fieldsGrouping("extractData_bolt", new Fields("timestampWithUrl"));        
